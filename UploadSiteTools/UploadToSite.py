...
l = db.FighterData.find({"fighterCode":fightercode},{"TotalPunchesLanded":1,  "_id":0}).distinct('TotalPunchesLanded');
ftotalpuncheslanded = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalPunchesThrown":1,  "_id":0}).distinct('TotalPunchesThrown');
ftotalpunchesthrown = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalGroundStrikesMade":1,  "_id":0}).distinct('TotalGroundStrikesMade');
ftotalgroundstrikeslanded = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalGroundStrikesThrown":1,  "_id":0}).distinct('TotalGroundStrikesThrown');
ftotalgroundstrikesthrown = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalClinchStrikesMade":1,  "_id":0}).distinct('TotalClinchStrikesMade');
ftotalclinchstrikeslanded = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalClinchStrikesThrown":1,  "_id":0}).distinct('TotalClinchStrikesThrown');
ftotalclinchstrikesthrown = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalKicksLanded":1,  "_id":0}).distinct('TotalKicksLanded');
ftotalkickslanded = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TotalKicksThrown":1,  "_id":0}).distinct('TotalKicksThrown');
ftotalkicksthrown = (l[0]) 



l = db.FighterData.find({"fighterCode":fightercode},{"SingleLegTakedownAttempts":1,  "_id":0}).distinct('SingleLegTakedownAttempts');
fsinglelegattempt2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"SingleLegTakedownSuccess":1,  "_id":0}).distinct('SingleLegTakedownSuccess');
fsinglelegsuccess2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"DoubleLegTakedownAttempts":1,  "_id":0}).distinct('DoubleLegTakedownAttempts');
fdoublelegattempt2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"DoubleLegTakedownSuccess":1,  "_id":0}).distinct('DoubleLegTakedownSuccess');
fdoublelegsuccess2 = (l[0]) 
...
l = db.FighterData.find({"fighterCode":fightercode},{"BodyLockTakedownAttempts":1,  "_id":0}).distinct('BodyLockTakedownAttempts');
fbodylockattempt2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"BodyLockTakedownSuccess":1,  "_id":0}).distinct('BodyLockTakedownSuccess');
fbodylocksuccess2 = (l[0]) 
...
l = db.FighterData.find({"fighterCode":fightercode},{"TimesBodyLocked":1,  "_id":0}).distinct('TimesBodyLocked');
ftimesbodylocked2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TimesTripped":1,  "_id":0}).distinct('TimesTripped');
ftimestripped2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TimesDoubleLegged":1,  "_id":0}).distinct('TimesDoubleLegged');
ftimesdoublelegged2 = (l[0]) 

l = db.FighterData.find({"fighterCode":fightercode},{"TimesSingleLegged":1,  "_id":0}).distinct('TimesSingleLegged');
ftimessinglelegged2 = (l[0]) 



straightPunchesThrown = fstraightsthrown + fjabsthrown
loopingPunchesThrown = fhooksthrown 
...
if weight == 265:
    fighterGrade = fighterGrade  - 10.2
...
print("Predictor Index: ", round(predictorIndex, 1))
...
mostCommonTypeTakenDown = str()

jabsThrownPerRound = int()
jabsLandedPerRound = int()
straightsThrownPerRound = int()
straightsLandedPerRound = int()
hooksThrownPerRound = int()
hooksLandedPerRound = int()
overhandThrownPerRound = int()
overhandLandedPerRound = int()
uppercutsThrownPerRound = int()
uppercutsLandedPerRound = int()
legKicksThrownPerRound = int()
legKicksLandedPerRound = int()
bodyKicksThrownPerRound = int()
bodyKicksLandedPerRound = int()
headKicksThrownPerRound = int()
headKicksLandedPerRound = int()
