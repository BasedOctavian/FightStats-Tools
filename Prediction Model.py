...
def getFighterA ():
    ...
    if weight == 145:
        grapplingGrade = (grapplingGrade / 1.5) + 32
    if weight == 155:
    ...
    afighterGrade = fighterGrade
    apowerGrade = powerGrade
    astrikingGrade = strikingGrade
    akickingGrade = kickingGrade
    agrapplingGrade = grapplingGrade
    adefensiveGrade = defenseGrade
    achinGrade = chinGrade
...
def getFighterB ():
    ...
    fightercode = "AlexanderVolkanovskiThe Great"
    ...
    bfighterGrade = fighterGrade
    bpowerGrade = powerGrade
    bstrikingGrade = strikingGrade
    bkickingGrade = kickingGrade
    bgrapplingGrade = grapplingGrade
    bdefensiveGrade = defenseGrade
    bchinGrade = chinGrade
